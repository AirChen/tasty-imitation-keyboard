#
#  Be sure to run `pod spec lint TastyImitationKeyboard.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/AirChen/tasty-imitation-keyboard.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "HostingApp/Keyboard/*.swift", "HostingApp/InputAssistant/*.swift"
